...
type ExamServiceClient interface {
	...
	// Client streaming
	SubmitExamResults(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SubmitExamResultsRequest, SubmitExamResultsResponse], error)
...
func (c *examServiceClient) SubmitExamResults(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[SubmitExamResultsRequest, SubmitExamResultsResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ExamService_ServiceDesc.Streams[1], ExamService_SubmitExamResults_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[SubmitExamResultsRequest, SubmitExamResultsResponse]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ExamService_SubmitExamResultsClient = grpc.ClientStreamingClient[SubmitExamResultsRequest, SubmitExamResultsResponse]
...
type ExamServiceServer interface {
	...
	// Client streaming
	SubmitExamResults(grpc.ClientStreamingServer[SubmitExamResultsRequest, SubmitExamResultsResponse]) error
	// Bidirectional streaming
...
func (UnimplementedExamServiceServer) SubmitExamResults(grpc.ClientStreamingServer[SubmitExamResultsRequest, SubmitExamResultsResponse]) error {
...
func _ExamService_SubmitExamResults_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ExamServiceServer).SubmitExamResults(&grpc.GenericServerStream[SubmitExamResultsRequest, SubmitExamResultsResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ExamService_SubmitExamResultsServer = grpc.ClientStreamingServer[SubmitExamResultsRequest, SubmitExamResultsResponse]
